...
/*   Updated: 2025/05/30 18:29:48 by qhatahet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// expander
void				quote_extention(t_token *token, t_expand *expand,
						char *temp, int *count);
...
void				free_heredoc(t_shell *shell, t_fds *fd);
void				if_not_text(int fd, t_shell *shell,
						char *exit_heredoc, char *text);
void				rl_loop(t_shell *shell, char *text,
						char *exit_heredoc, char *file);
void				ctrl_c_multiple(char *file, int fd,
						t_shell *shell, char *exit_heredoc);
